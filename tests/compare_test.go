...
func TestCompare_Parse(t *testing.T) {
	type fields struct {
		Left     string
	...
	tests := []struct {
		...
		{name: "test", fields: fields{Left: "variate_age_1", Operator: gisk.EQ, Right: "input_20_string"}, args: args{gisk: g}, wantBool: true, wantErr: false},
	}
